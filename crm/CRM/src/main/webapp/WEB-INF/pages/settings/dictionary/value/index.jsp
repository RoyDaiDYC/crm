            ...
            * */
            ...
            $("#tBody input[type='checkbox']").click(function () {
                ...
                * */
                ...
                if ($("#tBody input[type='checkbox']").size() === innerOnCheckBoxess.size()) {
...
<div style="position: relative; left: 30px; top: 20px;">
    <table class="table table-hover">
        ...
        <tbody id="tBody">
        <c:if test="${not empty dictionaryValueList}">
            <c:forEach items="${dictionaryValueList}" var="dv" varStatus="vs">
